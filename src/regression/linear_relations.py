...
def linear_relations():
    ...
    examples = {
        ...
        "4": ("Anzahl der Klassenarbeiten und benötigte Zeit zum Korrigieren für die Lehrkraft", True),
        "5": ("Länge des Schulwegs und benötigte Zeit", True),
        "7": ("Länge deiner Haare und die Anzahl der Freunde in der Klasse", False),
        "8": ("Wöchentliches Taschengeld und Menge an Pokemon-Karten, die du davon kaufen kannst", True),
    ...
    explanations = {"1": "Linear. Wenn du z.B. 50 Seiten in 1 Stunde liest, dann brauchst du für 100 Seiten 2 Stunden "
                    ...
                    "4": "Linear. Mehr Klassenarbeiten bedeuten im gleichen Maß mehr Korrekturzeit."
                         " Wenn dein Lehrer oder Lehrerin 5 Schularbeiten in 1 Stunde korrigiert, "
                         "korrigiert er/sie 10 in 2 Stunden, 15 in 3 Stunden.",
                    "5": "Linear. Je länger dein Schulweg ist, desto mehr Zeit brauchst du verhältnismäßig. "
                    ...
                    "10": "Linear. Je mehr Zeit du mit deinen Hausaufgaben verbringst, desto mehr Aufgaben kannst du erledigen. "
